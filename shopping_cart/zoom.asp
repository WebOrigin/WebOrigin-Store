...
<div class="picbox" show="show"><!--设置show显示默认图片-->
	...
	<img class="spic" lowsrc="images/b1.jpg" src="images/s1.jpg" onMouseMove="move(event,this,0)" dLeft="550" dTop="300" title="设置标签属性show='show'显示默认图片,设置dLeft,dTop定义默认偏移量"/><!--src:小图,lowsrc:大图,showW/showH:可设置预览窗大小-->
</div>
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b2.jpg" src="images/s2.jpg" onMouseMove="move(event,this,0)" showW="200" showH="200" title="通过设置标签属性showW,showH实现自定义预览图大小"/>
</div>
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b3.jpg" src="images/s3.jpg" width="320" onMouseMove="move(event,this,0)" title="小图可以按比例放大"/><!--这里可以重新设置小图大小,尽量与大图比例保持一致-->
</div>
	</td>
	<td>In table
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b1.jpg" src="images/s1.jpg" width="60" onMouseMove="move(event,this,0)" title="也可以按比例缩小"/>
</div>
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b1.jpg" src="images/s1.jpg" onMouseMove="move(event,this,0)" showW="500" showH="200" title="可以嵌套在table中"/>
</div>
	</td>
</tr>
</table>
...
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b2.jpg" src="images/s2.jpg" onMouseMove="move(event,this,0)" title="放在table外面也没有问题"/>
</div>
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/s3.jpg" src="images/s3.jpg" onMouseMove="move(event,this,0)" showW="1000" showH="1000" title="showW='1000' showH='1000',如果指定预览图比原图大,则使用原图大小" />
</div>
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b1.jpg" src="images/s1.jpg" onMouseMove="move(event,this,0)" showW="160" showH="320" title="代码较上一版本健壮,能在IE,FF下稳定工作,基本支持OP,欢迎大家帮助测试!"/>
</div>
<div class="picbox">
	<div class="view" onMouseMove="if (!isIE) move(event,this,1)"></div>
	<img class="spic" lowsrc="images/b2.jpg" src="images/s2.jpg" onMouseMove="move(event,this,0)" width="500" height="112" title="即使没有按比例拉伸,也可以正常工作"/>
</div>
</body>
</html>
